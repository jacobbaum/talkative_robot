...
class User < Person
	...
	# Got errors like this before comementing out
	# /Users/Jacob/ruby_scripts/talkative_robot/lib/robot_for_testing.rb:48:
	# in `gets': Is a directory @ io_fillbuf - fd:7 spec (Errno::EISDIR)
	...
	# /Users/Jacob/ruby_scripts/talkative_robot/lib/robot_for_testing.rb:104:
	# in `critique_user_age': undefined method `%' for nil:NilClass (NoMethodError)
...
class GroceryList
	...
	def item_grabbed?(item, user answer) 
		print "Did you grab #{item}? [Y/N] "
		user_answer == "Y"
	end	
